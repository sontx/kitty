...
{
    public sealed class CoccocHistoryCollector : IBrowserHistoryCollector
    {
        private IConnectionProvider inputProvider;
        private IConnectionProvider outputProvider;

        public CoccocHistoryCollector(IConnectionProvider inputProvider, IConnectionProvider outputProvider)
        {
